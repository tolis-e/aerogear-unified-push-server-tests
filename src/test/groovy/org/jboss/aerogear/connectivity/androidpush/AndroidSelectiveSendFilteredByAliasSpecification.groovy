...
@Mixin([AuthenticationUtils, PushApplicationUtils, AndroidVariantUtils,
	...
	iOSVariantUtils])
class AndroidSelectiveSendFilteredByAliasSpecification extends Specification {
	...
	def private final static String AUTHORIZED_LOGIN_NAME = "admin"

	def private final static String AUTHORIZED_PASSWORD = "123"
	...
	def static WebArchive "create deployment"() {
		Deployments.customUnifiedPushServerWithClasses(AndroidSelectiveSendFilteredByAliasSpecification.class)
	}
